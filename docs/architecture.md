...
graph TB
    ...
    subgraph CloudFront["Amazon CloudFront"]
        CF["CloudFront Distribution<br/>dfejazd8tb674.cloudfront.net"]
    end
    ...
    subgraph Auth["Amazon Cognito"]
        UserPool["User Pool<br/>ap-northeast-1_VNCSv95Dm<br/>(hanashite-tsukurun と共有)"]
...
| Cognito | ap-northeast-1_VNCSv95Dm | ユーザー認証 (hanashite-tsukurun と共有) |
